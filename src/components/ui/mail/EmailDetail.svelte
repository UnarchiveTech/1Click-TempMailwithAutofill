...
{#if currentEmailDetail}
  <div class="flex-1 px-4 py-3 space-y-3 overflow-y-auto">
    ...
    <div class="pt-3 border-t border-base-200">
      ...
      {:else}
        {#each emails as mail}
          <button class="w-full text-left py-2 border-b border-base-200 hover:bg-base-200 rounded-lg bg-transparent border-0 px-1" onclick={() => onOpenMessageDetail(mail)}>
