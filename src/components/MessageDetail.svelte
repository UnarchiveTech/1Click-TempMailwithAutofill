...
<div class="flex items-center justify-end px-4 py-2 border-b border-base-200">
  <button class="btn btn-ghost btn-sm gap-1 px-2" aria-label="Forward message" onclick={forwardMessage}>
